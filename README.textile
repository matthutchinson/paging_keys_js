...
* markup your entry titles with the following css heirachy; .hentry h2 a.entry-title (the example uses the "hAtom":http://microformats.org/wiki/hatom style)
* include the prototype library javascript
