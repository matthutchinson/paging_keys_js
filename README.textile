...
h2. "Demo":http://hiddenloop.github.com/sandbox/paging_keys/examples/prototype/example.html

Holy explanations Batman!, there is a "working (prototype) demo here":http://hiddenloop.github.com/sandbox/paging_keys/examples/prototype/example.html or you can try the "demo with jQuery":http://hiddenloop.github.com/sandbox/paging_keys/examples/jquery/example.html
