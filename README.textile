...
h2. Example Configuration Explanation (a "micro-formatted":http://microformats.org/ ( "hAtom":http://microformats.org/wiki/hatom ) blog page with pagination html from "will_paginate":http://wiki.github.com/mislav/will_paginate )
