...
h2. "Demo":http://homebrew.hiddenloop.com/sandbox/paging_keys/examples/prototype/example.html

Holy explanations Batman!, there is a "working demo here":http://homebrew.hiddenloop.com/sandbox/paging_keys/examples/prototype/example.html
