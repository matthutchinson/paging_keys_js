...
h2. Example Configuration Explanation (a "micro-formatted": ("hEntry":) blog page with pagination html from "will_paginate": , a popular rails paging gem)
